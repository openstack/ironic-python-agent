...
# Ironic Python Agent Release Notes documentation build configuration file,
...
release = ipa_version.version_string_with_vcs()
# The short X.Y version.
version = ipa_version.canonical_version_string()
...
htmlhelp_basename = 'IronicPythonAgentReleaseNotesdoc'
